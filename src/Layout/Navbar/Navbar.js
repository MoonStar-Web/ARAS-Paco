...
const Navbar = () => {
    ...
    const activeMenu = () => {
        if (path === "/" || path === "/home") {
            ...
            setmenu({ about: true })
        } else if (path === "/service" || path === "/service-packaging-design" || path === "/service-weeding-retouch" || path === "/service-packaging-study" || path === "/service-process-improvement") {
    ...
    useEffect(() => {
        console.log('WEBHAWK -- SAHIN ERKAN ARAS')
    ...
    <>
        <div className="page-wrapper">
            <header className="main-header">
                ...
                <nav className={`aras-navbar aras-navbargray main-menu ${sticky && "stricky-header stricked-menu stricky-fixed"}`}>
                    <div className="container">
                        ...
                        <ul className="main-menu__list mr-5 ">
                            <li className={`dropdown ${menu.home && "current"}`}>
                                <Link to="/">{t('home')}</Link>
                                
                            </li>
                            <li className={`dropdown ${menu.about && "current"}`}><Link to="/about">{t('about')}</Link> </li>
                            <li className={`dropdown ${menu.service && "current"}`}><Link to="/service">{t('services')}</Link></li>     
            ...
            <div  className="mobile-nav__content">
                ...
                <div  className="mobile-nav__container">
                    <ul className="main-menu__list">
                        ...
                        <li>
                        <Link to="/service" onClick={() => setmobile(false)}>{t('services')}</Link> 
                        </li>
                        <li>
