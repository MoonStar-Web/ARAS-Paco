                            ...
                            <div className="service-sidebar">
                                <div className="service-sidebar__category">
                                    ...
                                    <ul className="list-unstyled service-sidebar__category-list">
                                        <li><Link to="#">Ahşap Ambalaj</Link></li>
                                        <li><Link to="#">Karton Ambalaj</Link></li>
                                        <li><Link to="#">Plastik Ambalaj</Link></li>
                                        <li><Link to="#">Metal Ambalaj</Link></li>
                                        <li><Link to="#">Danışmanlık</Link></li>
                                        <li><Link to="#">Stok Yönetimi</Link></li>
                                    </ul>
                                </div>
                        ...
                        <div className="col-lg-8">
                            <div className="service-details__content">
                                <div className="service-details__image">
                                    <img src="assets/images/services/service-d-1-1.jpg" className="img-fluid" alt="" />
                                </div>
                                <h3>Ahşap Ambalaj</h3>
