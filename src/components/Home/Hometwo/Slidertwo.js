            ...
            <section className="main-slider main-slider__two">
                <Swiper className="swiper-container thm-swiper__slider"
                    ...
                    <div className="main-slider__nav">
                        <div className="swiper-button-prev" id="main-slider__swiper-button-next"><i className="aras-icon-left-arrow"></i>
                        </div>
                        <div className="swiper-button-next" id="main-slider__swiper-button-prev"><i className="aras-icon-right-arrow"></i>
                        </div>
                    </div>
                </Swiper>
            </section>
