                        ...
                        <div className="col-xl-5">
                            <div className="team-home__content">
                                ...
                                <div className="team-home__nav">
                                    <div className="swiper-button-prev" id="team-home__swiper-button-next"><i className="aras-icon-left-arrow"></i></div>
                                    <div className="swiper-button-next" id="team-home__swiper-button-prev"><i className="aras-icon-right-arrow"></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
